...
import AntecedentesHeredoFamiliares from './components/AntecedentesHeredoFamiliares';
import AntecedentesPersonalesNoPatologicos from './components/AntecedentesPersonalesNoPatologicos';
import AntecedentesPersonalesPatologicos from './components/AntecedentesPersonalesPatologicos';
import AntecedentesAlergicos from './components/AntecedentesAlergicos';
import AntecedentesQuirurgicos from './components/AntecedentesQuirurgicos';
import AntecedentesHemorragicos from './components/AntecedentesHemorragicos';
import AntecedentesGinecoObstetricos from './components/AntecedentesGinecoObstetricos';
...
import ExamenCabeza from './components/ExamenCabeza';
import ArticulacionCraneomandibular from './components/ArticulacionCraneomandibular';
import ExamenCuello from './components/ExamenCuello';
import ExamenIntrabucal from './components/ExamenIntrabucal';
import GlandulasSalivales from './components/GlandulasSalivales';
import Oclusion from './components/Oclusion';
import RelacionDientes from './components/RelacionDientes';
import LineaMedia from './components/LineaMedia';
import Frenillos from './components/Frenillos';
...
export const DentaxyFormPanel: React.FC<DentaxyFormPanelProps> = ({
  ...
  const handleContentGenerated = (seccionId: string, contenido: any, textoPlano?: string) => {
    ...
    // Notify parent if listener exists (Simplified)
