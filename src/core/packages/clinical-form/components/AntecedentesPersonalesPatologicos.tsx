...
const AntecedentesPersonalesPatologicos: React.FC<{
  ...
  const CategoriaPatologica = ({ categoria, titulo, opciones }: { categoria: string, titulo: string, opciones: { valor: string, etiqueta: string }[] }) => {
    return (
      <div className={`bg-transparent/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700 ${sinPatologia ? "hidden" : ""}`} style={{ overflowY: 'auto', maxHeight: '500px' }}>
