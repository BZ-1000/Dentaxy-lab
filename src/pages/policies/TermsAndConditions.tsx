    ...
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg mx-auto">
          ...
          <p className="text-gray-700">
            Bienvenido a Dentaxy, una plataforma desarrollada por Dental Basics Academy diseñada para generar 
            redacciones de historias clínicas odontológicas a partir de formularios seleccionables. Al acceder o 
            utilizar Dentaxy, usted acepta regirse por los presentes Términos y Condiciones. Si no está de acuerdo 
            con alguna parte de estos términos, le solicitamos no utilizar la Plataforma.
          </p>
          ...
          <p className="text-gray-700">
            4.1. No almacenamos ninguna información ingresada en los formularios. Dentaxy no guarda datos clínicos, 
            personales ni formularios completados en nuestros servidores. Todo el contenido generado vive únicamente 
            en el navegador del usuario.<br />
            4.2. <strong>Almacenamiento local:</strong> La función para "guardar formularios" se basa en el almacenamiento 
            local del navegador (cookies o almacenamiento local). Esto significa que los datos solo están disponibles 
            en el mismo dispositivo y navegador desde el cual fueron guardados. Si el usuario accede desde otro dispositivo, 
            incluso con la misma cuenta, dichos datos no estarán disponibles.<br />
            4.3. <strong>Responsabilidad sobre los archivos generados:</strong> Los archivos PDF generados mediante la 
            Plataforma son responsabilidad exclusiva del Usuario. Dentaxy no almacena ni respalda estos archivos. Le corresponde 
            al Usuario descargar, almacenar y proteger dichos documentos según las normativas legales de su país o región, 
            especialmente en lo relativo al manejo de datos sensibles y confidenciales.<br />
            4.4. El Usuario debe asegurarse de contar con el consentimiento adecuado de los pacientes antes de utilizar la 
            Plataforma para redactar historias clínicas.
          </p>
          ...
          <p className="text-gray-700">
            Nos reservamos el derecho de modificar estos Términos en cualquier momento. Le notificaremos sobre cambios sustanciales 
            mediante un aviso en la Plataforma o por correo electrónico. Su uso continuado tras dichas modificaciones implica 
