    ...
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg mx-auto">
          ...
          <p className="text-gray-700">
            <strong>Plataforma:</strong> Se refiere a la aplicación web Dentaxy y todos sus componentes funcionales.<br /><br />
            <strong>Usuario:</strong> Cualquier persona que acceda, cree una cuenta o utilice los servicios ofrecidos por Dentaxy.<br /><br />
