  ...
  return <div className="min-h-screen w-full bg-white apple-minimalist">
      ...
      <div className="flex flex-col items-center justify-center px-4 pt-12 pb-32 max-w-5xl mx-auto">
        <div className="text-center w-full">
          ...
          <div className="mb-5">
            <div className="inline-block bg-blue-500 text-white text-sm font-medium rounded-full mx-0 my-0 py-0 px-[80px]">Calidad y velocidad en redacción clínica, impulsadas por inteligencia artificial</div>
          </div>
