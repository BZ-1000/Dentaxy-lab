...
const HistoriaClinica = ({
  ...
  return (
    <div className={`${theme} min-h-screen w-full flex flex-col md:flex-row md:items-start md:gap-8 relative overflow-x-hidden p-4 sm:p-6 lg:p-8`}>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'} flex-1 transition-all duration-200 max-w-full overflow-x-hidden w-full`}>
