...
const HistoriaClinica = ({
  ...
  return (
    <div className={`${theme} min-h-screen w-full flex relative overflow-x-hidden`}>
      ...
      <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'} flex-1 py-6 sm:py-12 pl-10 pr-2 sm:pl-12 sm:pr-4 lg:px-8 transition-all duration-200 max-w-full overflow-x-hidden`}>
