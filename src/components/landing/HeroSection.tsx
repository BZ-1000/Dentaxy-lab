...
export const HeroSection = ({
  ...
  return <section className="relative h-screen flex flex-col items-center justify-center bg-background px-6 snap-start overflow-hidden">
      ...
      duration: 0.8
        ...
        <Button onClick={onExplore} size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-6 text-base rounded-full shadow-lg hover:shadow-xl transition-all">
