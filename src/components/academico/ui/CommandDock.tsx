...
export const CommandDock: React.FC<CommandDockProps> = ({
    ...
    return (
        <div className="absolute bottom-0 left-0 w-full z-50 p-6 pb-12 pointer-events-none flex flex-col items-center justify-end bg-gradient-to-t from-white via-white/90 to-transparent dark:from-black dark:via-black/90 h-40">
