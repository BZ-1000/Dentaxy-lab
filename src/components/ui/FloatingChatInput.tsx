        ...
        marginBottom: '120px'
          ...
          maxWidth: '350px'
              ...
              <div className="pointer-events-auto bg-gray-800/80 backdrop-blur-md rounded-2xl border border-gray-600/50 shadow-2xl p-3 relative">
                ...
                <div className="absolute -top-2 left-4 text-xs font-mono text-emerald-400 shadow-emerald-400 [text-shadow:0_0_8px_var(--tw-shadow-color)] rounded-full font-medium px-[8px] py-0 mx-0 my-0 bg-gray-900">⚡️versión experimental</div>
