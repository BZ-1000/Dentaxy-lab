...
export const SidebarLink = ({
  ...
  const content = <div className={cn("flex items-center justify-start gap-2 group/sidebar py-2 cursor-pointer", className)} onClick={link.onClick} {...props}>
    ...
    }} className="text-neutral-700 dark:text-neutral-200 text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0 text-left">
        {link.label}
      </motion.span>
    </div>;
  return content;
