...
const AntecedentesPersonalesPatologicos: React.FC<AntecedentesPersonalesPatologicosProps> = ({
  ...
  const generarRedaccionIA = () => {
    ...
    // Set up typing animation for each category
    const newIsTyping = Object.keys(nuevasRedacciones).reduce((acc, key) => {
      acc[key] = true;
      return acc;
  ...
  const handleTypingComplete = (section: string) => {
    setIsTyping(prev => ({
      ...prev,
      [section]: false
    }));
                ...
                {progress === 100 && (
                  <>
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          text={redacciones.nutricionales}
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('nutricionales')}
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('cardiacos')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('hepaticos')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('enfermedadesTransmisionSexual')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('enfermedadesEruptivas')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('pulmonares')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('infecciosasParasitarias')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                      ...
                      <div className="min-h-[100px] p-3 text-sm bg-white/50 dark:bg-gray-800/50 rounded border border-gray-200 dark:border-gray-700">
                        <Typewriter 
                          ...
                          speed={5}
                          cursor={null}
                          onComplete={() => handleTypingComplete('otrosPadecimientos')}
                          className="whitespace-pre-wrap"
                        />
                      </div>
                    </div>
