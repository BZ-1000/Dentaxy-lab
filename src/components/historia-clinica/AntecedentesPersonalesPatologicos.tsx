...
const AntecedentesPersonalesPatologicos = ({ formData, handleInputChange }: AntecedentesPersonalesPatologicosProps) => {
  ...
  const generarRedaccionIA = () => {
    const antecedentesPatologicos = formData.antecedentesPersonalesPatologicos || "";
    
    let textoGenerado = "";
    if (!antecedentesPatologicos || antecedentesPatologicos.trim() === "") {
      textoGenerado = "El paciente niega antecedentes personales patológicos de relevancia para su condición actual.";
    } else {
      textoGenerado = `El paciente refiere los siguientes antecedentes personales patológicos: ${antecedentesPatologicos}`;
    }
  ...
  const limpiarFormulario = () => {
    handleInputChange("antecedentesPersonalesPatologicos", "");
    setRedaccionIA("");
            ...
            {showRedaccion ? (
              ...
              <div className="p-6 space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="antecedentesPatologicos">Describa los antecedentes personales patológicos del paciente:</Label>
                  <Textarea
                    id="antecedentesPatologicos"
                    placeholder="Describa enfermedades crónicas, cirugías previas, hospitalizaciones, etc..."
                    value={formData.antecedentesPersonalesPatologicos || ""}
                    onChange={(e) => handleInputChange("antecedentesPersonalesPatologicos", e.target.value)}
                  ...
                  <div className="mt-2">
                    <VoiceInput
                      onTranscriptionComplete={(text) => {
                        const currentText = formData.antecedentesPersonalesPatologicos || "";
                        handleInputChange("antecedentesPersonalesPatologicos", currentText ? `${currentText} ${text}` : text);
                      }}
                    />
                  </div>
                </div>
