...
const AntecedentesPersonalesPatologicos: React.FC<{
  ...
  return (
    <div className={`max-w-4xl mx-auto transition-all duration-300 ${isMaximized ? "fixed inset-4 z-50" : ""}`} data-formulario-section="antecedentes-personales-patologicos">
