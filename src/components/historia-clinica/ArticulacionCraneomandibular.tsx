...
const integridadOptions: Option[] = [
    ...
    { label: "Con fisuras", value: "fisuras" }, // Permite seleccionar fisuras aquí también
];
...
const lipNarrativePhrases: { [key: string]: { [value: string]: string } } = {
    simetria: {
    ...
    hidratacion: { // Corresponde a las opciones de 'superficieOptions'
    ...
    integridad: {
        intactos: "La integridad de la mucosa se mantiene, sin lesiones ni interrupciones del epitelio.", // Más conciso
        heridas: "La mucosa labial muestra heridas superficiales.", // Más directo
    ...
    movimiento: {
        ...
        restriccion: "Durante la exploración funcional se detecta restricción de movimiento.", // Más directo
...
const ArticulacionCraneomandibular: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (targetLipsNarrative && isGeneratingLipsNarrative) { // Asegura que solo anime si está generando
            let index = 0;
                                ...
                                <section>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        {formData.dolorMasticarHablar === true && (
                                         ...
                                         {/* Dolor Específico */}
                                         <div>
                                             <h4 className="text-md font-medium mb-2 text-gray-700 dark:text-gray-300">Dolor específico localizado</h4>
                                             <div className="flex gap-3">
