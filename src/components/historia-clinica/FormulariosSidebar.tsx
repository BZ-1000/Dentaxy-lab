...
// Fixed imports removing missing exports from modern-sidebar
// We only have SidebarLink in modern-sidebar.tsx, so adjust imports accordingly
import { SidebarLink } from '@/components/ui/modern-sidebar';
...
const FormulariosSidebar = ({
  ...
  const [open, setOpen] = useState(true); // default open to true to show sidebar links
  ...
  return (
    <div className="">
      <div className="sticky top-0 h-screen hidden md:block w-64 border-r border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-neutral-700">
          ...
          {nombrePaciente && (
            ...
            >
              Quitar nombre / Resetear formulario
