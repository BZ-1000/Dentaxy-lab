...
const AntecedentesAlergicos = ({ formData, handleInputChange }: AntecedentesAlergicosProps) => {
  ...
  const generarRedaccionIA = () => {
    const antecedentesAlergicos = formData.antecedentesAlergicos || "";
    
    let textoGenerado = "";
    if (!antecedentesAlergicos || antecedentesAlergicos.trim() === "") {
      textoGenerado = "El paciente niega antecedentes alérgicos a medicamentos, alimentos, o sustancias ambientales.";
    } else {
      textoGenerado = `El paciente refiere los siguientes antecedentes alérgicos: ${antecedentesAlergicos}`;
    }
  ...
  const limpiarFormulario = () => {
    handleInputChange("antecedentesAlergicos", "");
    setRedaccionIA("");
            ...
            {showRedaccion ? (
              ...
              <div className="p-6 space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="antecedentesAlergicos">Describa los antecedentes alérgicos del paciente:</Label>
                  <Textarea
                    ...
                    onChange={(e) => handleInputChange("antecedentesAlergicos", e.target.value)}
                  ...
                  <div className="mt-2">
                    <VoiceInput
                      onTranscriptionComplete={(text) => {
                        const currentText = formData.antecedentesAlergicos || "";
                        handleInputChange("antecedentesAlergicos", currentText ? `${currentText} ${text}` : text);
                      }}
                    />
                  </div>
                </div>
