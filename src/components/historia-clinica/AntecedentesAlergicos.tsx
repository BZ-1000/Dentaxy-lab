...
const AntecedentesAlergicos: React.FC<AntecedentesAlergicosProps> = ({
  ...
  return (
    <div className={`max-w-4xl mx-auto transition-all duration-300 ${isMaximized ? "fixed inset-4 z-50" : ""}`} data-section-redaction="true" data-section-name="antecedentesAlergicos" data-formulario-section="antecedentes-alergicos">
