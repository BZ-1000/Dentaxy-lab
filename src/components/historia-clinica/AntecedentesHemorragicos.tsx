...
const AntecedentesHemorragicos: React.FC<AntecedentesHemorragicosProps> = ({
  ...
  return (
    <div className={`max-w-4xl mx-auto transition-all duration-300 ${isMaximized ? "fixed inset-4 z-50" : ""}`} data-section-redaction="true" data-section-name="antecedentesHemorragicos">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex gap-4">
                      <button 
                        className={`px-4 py-2 rounded-md text-sm transition-colors ${formData.antecedentesHemorragicos.transfusionPrevia ? 'bg-[#2ecc71] text-white' : 'bg-gray-100 dark:bg-gray-700'}`} 
                        onClick={() => handleBooleanChange('transfusionPrevia', true)}
                      >
                        Sí
                      </button>
                      <button 
                        className={`px-4 py-2 rounded-md text-sm transition-colors ${formData.antecedentesHemorragicos.transfusionPrevia === false ? 'bg-[#2ecc71] text-white' : 'bg-gray-100 dark:bg-gray-700'}`} 
                    ...
                    <>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-2">
                            <button className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center hover:bg-blue-600 transition-colors">
                              <AIVoiceInput onTranscriptionComplete={handleVoiceInput('motivoTransfusion')} />
                            </button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-2">
                            <button className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center hover:bg-blue-600 transition-colors">
                              <AIVoiceInput onTranscriptionComplete={handleVoiceInput('fechaTransfusion')} />
                            </button>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        <button className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center hover:bg-blue-600 transition-colors">
                          <AIVoiceInput onTranscriptionComplete={handleVoiceInput('detallesAdicionales')} />
                        </button>
                      </div>
                    </div>
                  </div>
