...
const AntecedentesHemorragicos: React.FC<AntecedentesHemorragicosProps> = ({
  ...
  const handleNoAntecedentes = () => {
    // Reset all values and set to default "no antecedents" state
    handleAntecedenteHemorragicoChange('transfusionPrevia', false);
    handleAntecedenteHemorragicoChange('motivoTransfusion', '');
    handleAntecedenteHemorragicoChange('fechaTransfusion', '');
    handleAntecedenteHemorragicoChange('detallesAdicionales', 'El paciente no presenta antecedentes hemorrágicos.');
    
    toast({
      title: "Formulario actualizado",
      description: "Se ha registrado que el paciente no presenta antecedentes hemorrágicos",
    });
  ...
  const generateRedaccion = () => {
    ...
    setTimeout(() => {
      ...
      if (formData.antecedentesHemorragicos.transfusionPrevia) {
