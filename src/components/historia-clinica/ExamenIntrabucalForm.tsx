...
const ExamenIntrabucalForm: React.FC<ExamenIntrabucalFormProps> = ({
    ...
    return options.map((option) => (
      <div key={option} className="flex flex-col w-full sm:w-auto">
        <Button
          ...
          className="text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-2 min-h-[2rem] sm:min-h-[2.5rem] whitespace-normal text-left justify-center"
        >
          {option}
        </Button>
  ...
  const ColorSelector = () => (
    <div>
      ...
      <p className="text-xs sm:text-sm text-gray-600 mb-3">Descripción clínica común</p>
      <div className="space-y-2">
        {colorOptions.map((option, index) => (
          <div key={index} className="flex items-start space-x-2 sm:space-x-3">
            ...
            <Button
              ...
              className="text-left justify-start h-auto p-2 sm:p-3 text-xs sm:text-sm w-full whitespace-normal"
            >
              {option.label}
            </Button>
          </div>
        ...
        <div className="flex flex-col">
          ...
          {otroTextareas["Otro color"] && (
            <Textarea placeholder="Especifica el color..." className="mt-2 text-sm" />
          )}
        </div>
      </div>
    </div>
  ...
  const renderEnciasForm = () => {
    ...
    return (
      <div className="space-y-4">
        <div>
          <p className="text-xs sm:text-sm text-gray-600 mb-3">Subtipos de encía:</p>
        ...
        <div className="border-t pt-4">
          <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">{currentSection}</h3>
          ...
          <div className="mt-4">
            ...
            <Textarea id="encias-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
          </div>
          ...
          {currentSubSection === sections.length - 1 && (
            <div className="flex justify-center mt-4">
              <Button 
                ...
                className="bg-emerald-500 hover:bg-emerald-600 text-white text-sm sm:text-base px-6 py-2"
              >
                Guardar
              </Button>
            </div>
  ...
  const renderPaladarForm = () => {
    ...
    return (
      <div className="space-y-4">
        <div>
          <p className="text-xs sm:text-sm text-gray-600 mb-3">Divisiones:</p>
          <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
            <p>Paladar duro</p>
            <p>Paladar blando</p>
          </div>
        ...
        <div className="border-t pt-4">
          ...
          <div className="mt-4">
            ...
            <Textarea id="paladar-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
          </div>
  ...
  const renderOrofaringeForm = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        <Textarea id="orofaringe-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
      </div>
  ...
  const renderMejillasForm = () => (
    <div className="space-y-4">
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          <div className="flex flex-col w-full">
            <Button
              ...
              className="text-xs sm:text-sm px-2 py-1 min-h-[2rem]"
            >
              Presente
            </Button>
          </div>
        ...
        {showManchasTextarea && (
          <Textarea placeholder="Describe las manchas..." className="mt-2 text-sm" />
        )}
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="flex flex-col w-full">
            <Button
              ...
              className="text-xs sm:text-sm px-2 py-1 min-h-[2rem] whitespace-normal text-center"
            >
        ...
        {showLesionTextarea && (
          <Textarea placeholder="Describe la lesión..." className="mt-2 text-sm" />
        )}
      </div>
      ...
      <div>
        ...
        <Textarea id="mejillas-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
      </div>
  ...
  const renderRetromolarForm = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        <Textarea id="retromolar-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
      </div>
  ...
  const renderLenguaForm = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        <Textarea id="lengua-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
      </div>
  ...
  const renderPisoBocaForm = () => (
    <div className="space-y-4">
      ...
      <div>
        ...
        <Textarea id="piso-otros" placeholder="Describe otros hallazgos..." className="mt-2 text-sm" />
      </div>
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto relative">
        {/* Fixed red X button - only visible element */}
        <button
          onClick={onClose}
          className="fixed top-4 right-4 z-50 p-2 rounded-full bg-red-50 text-red-600 hover:bg-red-100 transition-colors shadow-md border border-red-200"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <DialogHeader className="pb-4 border-b mb-4">
          <DialogTitle className="text-lg sm:text-xl font-semibold pr-12">
            {getAreaTitle()}
          </DialogTitle>
        </DialogHeader>
        
        {/* Form content with mobile-responsive padding */}
