                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        className={`px-4 py-2 rounded-md text-sm transition-colors ${
                          formData.antecedentesQuirurgicos.tratamientoReciente === false
                            ? 'bg-[#2ecc71] text-white'
                            : 'bg-gray-100 dark:bg-gray-700'
                        }`}
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        className={`px-4 py-2 rounded-md text-sm transition-colors ${
                          formData.antecedentesQuirurgicos.hospitalizacionReciente === false
                            ? 'bg-[#2ecc71] text-white'
                            : 'bg-gray-100 dark:bg-gray-700'
                        }`}
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        className={`px-4 py-2 rounded-md text-sm transition-colors ${
                          formData.antecedentesQuirurgicos.tomaMedicamentos === false
                            ? 'bg-[#2ecc71] text-white'
                            : 'bg-gray-100 dark:bg-gray-700'
                        }`}
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center">
                      <Textarea
                        value={formData.antecedentesQuirurgicos.cualesMedicamentos || ''}
