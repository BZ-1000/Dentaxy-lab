  ...
  return <div className="space-y-4">
      <div className="flex items-center gap-2 flex-row-reverse justify-end">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button variant="outline" size="icon" className="relative h-10 w-10 rounded-full border-2 border-primary/20 bg-background hover:bg-accent hover:text-accent-foreground transition-all duration-100 shadow-md hover:shadow-lg">
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <Textarea value={dolor.localizacion.descripcion} onChange={e => onDolorChange('localizacion', JSON.stringify({
          ...dolor.localizacion,
          descripcion: e.target.value
        }))} placeholder="Describa la localización del dolor. INICIANDO CON Localizado en ..." className="min-h-[135px] max-h-[135px] w-[75%]" />
          <div className="h-[40px]">
            <VoiceInput onTranscriptionComplete={text => onDolorChange('localizacion', JSON.stringify({
            ...dolor.localizacion,
            descripcion: text
          }))} />
          </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <Textarea value={dolor.atenuacion} onChange={e => onDolorChange('atenuacion', e.target.value)} placeholder="Describe que empeora el dolor (frío,caliente,) o que lo disminuye (analgésicos)" className="min-h-[135px] max-h-[135px] w-[75%]" />
          <div className="h-[40px]">
