      ...
      <nav className="max-w-screen-xl mx-auto px-2 md:px-4">
        <div className="flex justify-around items-center h-12 md:h-16 overflow-x-auto">
          ...
          <button 
            ...
            className="flex flex-col items-center gap-0.5 text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-primary transition-colors duration-200"
          >
            <Settings className="h-4 w-4 md:h-5 md:w-5" />
            <span className="text-[0.65rem] md:text-xs">Ajustes</span>
          </button>
          ...
          >
            ...
            <span className="text-[0.65rem] md:text-xs">Perfil</span>
          </button>
        </div>
      </nav>
    </div>
