        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <LayoutGrid className="h-[18px] w-[18px]" style={{ color: '#EC4899', strokeWidth: 1.5 }} />
              </motion.button>
            </TooltipTrigger>
  ...
  return (
    <>
      <motion.button
        ...
        onClick={() => setOverlayOpen(true)}
      >
        <LayoutGrid className="h-[18px] w-[18px] flex-shrink-0" style={{ color: '#EC4899', strokeWidth: 1.5 }} />
        <div className="flex-1 min-w-0">
          <p className="text-xs font-medium">Módulos</p>
          <p className="text-[10px] text-muted-foreground">Herramientas extra</p>
        </div>
      </motion.button>
      <ModulosOverlay open={overlayOpen} onClose={() => setOverlayOpen(false)} />
    </>
