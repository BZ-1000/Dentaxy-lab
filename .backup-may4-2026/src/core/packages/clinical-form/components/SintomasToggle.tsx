  ...
  return (
    <button
      ...
      className={cn(
        ...
        checked 
          ? "bg-emerald-500 text-white border-blue-600 hover:bg-blue-600 dark:bg-blue-600 dark:text-white dark:border-blue-700 dark:hover:bg-blue-700" 
    ...
    >
      ...
      <span className="text-xs sm:text-sm text-blue-200 dark:text-blue-300 ml-1 sm:ml-2">
